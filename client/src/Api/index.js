...
const API=axios.create({baseURL:`https://videostream-1b43.onrender.com/`})
...
export const likeComment = (id) => API.patch(`/comment/action/like/${id}`);
export const dislikeComment = (id) => API.patch(`/comment/action/dislike/${id}`);
export const translateComment = (id, targetLang) => API.post(`/comment/action/translate/${id}`, { targetLang });
